    ...
    <section className="relative min-h-screen sm:m-5 md:m-10 rounded-md overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center  ">
        <h2 className="text-3xl font-bold mb-2 pt-10 ">
          <span className="bg-linear-to-r from-[#52cdd4] to-indigo-600 p-2 rounded-md ">
            <span className="bg-linear-to-r from-[#CB52D4] to-indigo-600">
              {" "}
              Explore Our
            </span>{" "}
            <span className=" bg-linear-to-r from-[#CB52D4] to-indigo-600 rounded-md  text-orange-600">
              Categories
            </span>
          </span>
        </h2>
