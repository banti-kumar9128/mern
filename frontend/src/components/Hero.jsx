...
const Hero = () => {
  ...
  return (
   <div>  <section className="flex flex-col items-center text-white text-sm pb-20 px-4 font-poppins">
          {/* BACKGROUND IMAGE */}
  ...
  muted
  playsInline
  className="absolute inset-0 -z-10 w-full h-full object-cover opacity"
>
  <source
    src={video}
    type="video/mp4"
  />
        ...
        <Link to= '/menu' className="flex items-center gap-2 border border-slate-700 rounded-full p-1 pr-3 text-sm mt-20">
